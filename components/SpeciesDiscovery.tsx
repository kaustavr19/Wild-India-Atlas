...
export function SpeciesDiscovery({ items }: { items: SpeciesDiscoveryItem[] }) {
  ...
  return (
    <main className="min-h-screen bg-paper text-ink">
      ...
      <section className={`${filters.biome === "all" ? "biome-forest" : biomeClassName[filters.biome]} relative px-4 py-2 sm:px-6 lg:sticky lg:top-[68px] lg:z-30`} aria-label="Species observation lens">
        <div className="field-filter-dock mx-auto max-w-7xl rounded-field border border-white/12 p-4">
