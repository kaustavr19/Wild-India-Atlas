...
export type SightingDifficulty = "Easy" | "Moderate" | "Difficult" | "Very Difficult";
export type Species = { id:string; slug:string; commonName:string; scientificName:string; category:string; shortDescription:string; habitat:string; conservationStatus:string; viewingTips:string; difficultyOfSighting:SightingDifficulty; photographyTips:string; similarSpeciesSlugs:string[] };
